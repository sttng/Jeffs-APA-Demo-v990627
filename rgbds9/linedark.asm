...
;
; Horizontal lines:
;  black/white - 8888 lines/sec (64 pixel)
;  black/white - 7800 lines/sec (128 pixel)
;
;  grey scale - 8727 lines/sec (64 pixel)
;  grey scale - 7742 lines/sec (128 pixel)
