...
;  Black/White -
;   Size: X= 120,   Y= 100    ~73 triangles/sec  (? tri/sec 8x8 tex, ? for pattrn tex)
;   Size: X= 0-128, Y= 0-128  ~? triangles/sec (75 tri/sec 8x8 textured)
;   Size: X= 0-63,  Y= 0-63   ~? triangles/sec (152 tri/sec 8x8 textured)
;   Size: X= 9,     Y= 9      ~? triangles/sec
;
;  Grey Scale
;   Size: X= 120,   Y= 100    ~70 triangles/sec  (? tri/sec 8x8 tex, ? for pattrn tex)
;   Size: X= 0-128, Y= 0-128  ~? triangles/sec (75 tri/sec 8x8 textured)
;   Size: X= 0-63,  Y= 0-63   ~? triangles/sec (152 tri/sec 8x8 textured)
;   Size: X= 9,     Y= 9      ~? triangles/sec
