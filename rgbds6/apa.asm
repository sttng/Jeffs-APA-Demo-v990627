...
RENDER_TO_VRAM     equ     0     ; 0 = $C000, 1 = $8000

GREY_SCALE         equ     1     ; 0 = black/white, 1 = Grey Scale

HIGH_LINE_PREC     equ     0     ; 0 = low line precision, 1 = high line precision

LEFT_LINE_MASK_ADDR     equ     $200  ; MUST be $xx00 (page aligned)
RIGHT_LINE_MASK_ADDR    equ     $300  ; MUST be $xx00 (page aligned)
SinTable        equ     $04
CosTable        equ     $05
ZDivTable       equ     $06
...
GeneralHRAM equ     $ff90
TriangleHRAM equ    $ffb0
